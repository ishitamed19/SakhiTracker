            ...
            <FormControl className={classes.formControl}>
                ...
                <div style={{marginTop: '20px', marginBottom: '30px'}}>
                    ...
                    >
                        ...
                        <MenuItem value={3}>Daily Walk</MenuItem>
                        <MenuItem value={4}>Jogging</MenuItem>
                        <MenuItem value={5}>Running</MenuItem>
                        <MenuItem value={6}>Cycling</MenuItem>
                        <MenuItem value={7}>Gym</MenuItem>
                        <MenuItem value={8}>Meditation</MenuItem>
                        <MenuItem value={9}>Stretching</MenuItem>
                    </Select>
                </div>
                <Typography id="discrete-slider" gutterBottom>
                    Duration
